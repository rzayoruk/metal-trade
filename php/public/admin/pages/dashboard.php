                                ...
                                <ul class="contacts-list">
                                    ...
                                    <li>
                                        <a href="#">
                                            <img
                                                class="contacts-list-img"
                                                src="<?= "../temp/AdminLTE-3.1.0/" ?>dist/img/user7-128x128.jpg"
                                                alt="User Avatar" />
                                    ...
                                    <li>
                                        <a href="#">
                                            <img
                                                class="contacts-list-img"
                                                src="<?= "../temp/AdminLTE-3.1.0/" ?>dist/img/user5-128x128.jpg"
                                                alt="User Avatar" />
                                    ...
                                    <li>
                                        <a href="#">
                                            <img
                                                class="contacts-list-img"
                                                src="<?= "../temp/AdminLTE-3.1.0/" ?>dist/img/user6-128x128.jpg"
                                                alt="User Avatar" />
