                            ...
                            <tbody>
                                <?php foreach ($images as $image): ?>
                                    <tr>
                                        ...
                                        <td><a href="/../includes/product-delete.php?id=<?= $product["id"] ?>" onclick="return confirm('Are you sure to delete product?')"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve" width=40>
