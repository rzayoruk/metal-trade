                    ...
                    <div class="card-body">
                            ...
                            <tbody>
                                <?php foreach ($images as $image): ?>
                                    <tr>
                                        ...
                                        <td><a style="cursor:pointer;" onclick="return confirm('Are you sure to delete product?') ? deleteProduct(this) :false "><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve" width=40>
                        ...
                        <script>
                                    ...
                                    if (file) {
                                        ...
                                        reader.onload = function(e) {
                                            ...
                                            if (!fileInput.nextElementSibling) {
                                                ...
                                                existedJsPreview.style.display = "inline";
                            ...
                            function deleteProduct(deleteIcon) {
                                ...
                                const imageId = row.querySelector(".imageId").textContent;

                                fetch("../includes/image-gallery-delete.php?imageId=" + imageId)
                                    .then(response => {
                                        if (response.status == 200) {
                                            return response.json();
                                        } else {
                                            Swal.fire({
                                                icon: "error",
                                                title: "Error!",
                                                text: "Error when deleting process.",
                                                timer: 3000,
                                                showConfirmButton: false
                                            });
                                        }
